...
while (rc_column == 0):
	row = 0;
	rc_column = os.system('wget http://media.blizzard.com/heroes/images/battlegrounds/maps/towers-of-doom/main/6/' + str(column) + '/' + str(row) + '.jpg -O ' + str(1000 + column) + '-' + str(1000 + row) + '.jpg')
	rc_row = rc_column
	while (rc_row == 0):
		row += 1
		rc_row = os.system('wget http://media.blizzard.com/heroes/images/battlegrounds/maps/towers-of-doom/main/6/' + str(column) + '/' + str(row) + '.jpg -O ' + str(1000 + column) + '-' + str(1000 + row) + '.jpg')
